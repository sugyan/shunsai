...
<!-- BENCH_HISTORY_BEGIN -->
| date | rev | perft startpos-d4 Mnps | perft startpos-d4 -cb | perft startpos-d4 -mat | perft matsuri-d3 Mnps | perft matsuri-d3 -cb | perft matsuri-d3 -mat | movegen matsuri µs | movegen sampled-v1 µs/pos | movegen sampled-v1 -cb | movegen sampled-v1 -buf | do_undo ns/pair | note |
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
...
| 2026-08-04 | ded13fc | 178.5 | 257.4 | 179.8 | 631.2 | 869.7 | 583.7 | 0.25 | 0.20 | 0.09 | 0.20 | 11.0 | MoveSet::write_into + legal_moves() routed through it; perft/matsuri-cb/3 unstable under whole-suite conditions (sigma 27%, cause unresolved) - its series is not comparable with 2026-08-03, see DESIGN.md; the other 45 ids are sigma <= 4% |
<!-- BENCH_HISTORY_END -->
