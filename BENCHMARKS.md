...
| 2026-07-30 | 97e28b2 | 184.4 | 556.9 | 0.29 | 0.20 | 10.8 | king danger bitboard (one per node, filtered to the king's neighbourhood) + checkers/pins fused into one scan; movegen/maxmoves-cb at sigma 5.7%; recorded on 3-run agreement (reported time 101.94/101.11/100.84 ns), not on duration |
<!-- BENCH_HISTORY_END -->
