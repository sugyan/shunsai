...
- **Before E0 (done 2026-08-13)**: publish v0.1.0 on crates.io. Not optional sequencing — `rinsai` depends on released versions rather than a git pin, so the release is what E0 builds against. It was also the **last point at which an API break was free**, so it gated more than packaging:
